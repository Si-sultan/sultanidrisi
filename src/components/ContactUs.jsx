...
const ContactUs = () => {
  ...
  return (
    ...
    mx-auto items-center'>
        <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl xl:top-0 md:top-0 sm:h-screen'>
            Contact
        </h3>
        ...
        <div className='flex flex-col space-y-10'>
            ...
            <div className='space-y-10'>
                <div className='flex items-center space-x-5 justify-center'>
                    ...
                    <p className='text-2xl'>+919372562296</p>
                </div>

                <div className='flex items-center space-x-5 justify-center'>
                    <EnvelopeIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse'/>
                    <p className='text-2xl'>isultanjaved@gmail.com</p>
                </div>

                <div className='flex items-center space-x-5 justify-center'>
                    <MapPinIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse'/>
                    <p className='text-2xl'>Mumbai - 400051, Maharashtra, India</p>
                </div>
            </div>
