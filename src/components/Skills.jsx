  ...
  return (
    ...
    <div className='flex flex-col xl:flex-row space-y-10'>
            ...
            mx-auto items-center'>
                <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl min-[250px]:text-xl min-[250px]:mb-8'>
                    SEO Skills
                </h3>
            ...
            mx-auto items-center xl:bottom-[50px]'>
                <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl min-[250px]:text-xl'>
                    development
                </h3>
                <h3 className='absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm xl:left-12'>
                    Hover over a skill for currency proficiency
